...
- analyseImage
  ...
  - params:
  -> source: "webcam" | "screenshot": source de l'image
  -> prompt: texte: ce que tu demandes de l'image
  -> renew: true|false: capturer une nouvelle image (true) ou garder la dernière image capturé (false)
  - exemples de cas d'utilisation:
  -> Regarde
  -> Que vois-tu ?
...
- openLink
  ...
  - params:
  -> link: lien à ouvrir dans un navigateur pour montrer à l'utilisateur
  - exemples de cas d'utilisation:
  -> Je veux voir une vodéo youtube
...
# =====================
def chat():
    print("🤖 JARVIS — exit pour quitter\n")
